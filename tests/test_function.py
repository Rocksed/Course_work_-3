...
def test_get_data(test_url):
    ...
    assert get_data("https://homewor.url.com")[0] is None
    assert get_data("https://github.com/Rocksed/git_project/tree/main/src")[0] is None
    assert get_data("https://github.com/Rocksed/git_project2/tree/main/src")[0] is None
